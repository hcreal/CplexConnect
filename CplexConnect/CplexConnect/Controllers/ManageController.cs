...
namespace CplexConnect.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult Users()
        {
            ...
            roleId = roles.Where(r => r.Value == "staff").FirstOrDefault().Key;
            var normalUsers = users.Where(u => u.Roles.Any(r => r.RoleId == roleId)).ToList();
        ...
        public ActionResult ResetUserPassword(string Id)
        {
            ...
            userManager.AddPassword(Id, "Alabama2017");
